...
export function RoleMutateRouteSection({ children }: { children: ReactNode }) {
  ...
  return (
    <section className="space-y-3">
      <SectionHeader
        title={t("roles.sections.route.title")}
        description={t("roles.sections.route.description")}
      />
...
export function RoleMutateDisplaySection({
  children,
}: {
  children: ReactNode
}) {
  ...
  return (
    <section className="space-y-3">
      <SectionHeader
        title={t("roles.sections.display.title")}
        description={t("roles.sections.display.description")}
      />
...
export function RoleMutateSheetFooter({
  isBusy,
  submitLabel,
  onCancel,
}: {
